 ...
 */
const formatTheme = <F, G, I, L, C, CT>(
  variables: ThemeVariables,
  theme: Partial<Theme<F, G, I, L, C, CT>>,
) => {
 ...
 */
const buildTheme = <F, G, I, L, C, CT>(
  darkMode: boolean,
  baseTheme: Theme<F, G, I, L, C, CT>,
  themeConfig: Partial<Theme<F, G, I, L, C, CT>>,
  darkThemeConfig: Partial<Theme<F, G, I, L, C, CT>>,
) => {
  return {
 ...
 */
const mergeTheme = <F, G, I, L, C, CT>(
  baseTheme: Theme<F, G, I, L, C, CT>,
  theme: Partial<Theme<F, G, I, L, C, CT>>,
  darkTheme: Partial<Theme<F, G, I, L, C, CT>>,
) =>
